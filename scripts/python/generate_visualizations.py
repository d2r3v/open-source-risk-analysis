...
Data Source: data/exports/extracted_package_risk_summary.csv
"""
...
def main():
    ...
    # =========================================================================
    # Chart 1: Overall Severity Score Distribution (Boxplot) - IMPROVED
    # =========================================================================
    ...
    if not vulnerable_df.empty:
        ...
        # Improvements: Title, Grid, Annotations
        ...
        plt.close()
        print("- Saved: severity_distribution_boxplot.png (Improved)")
    ...
    # =========================================================================
    # Chart 3: Stars by High-Severity Label (Boxplot) - IMPROVED
    # =========================================================================
    plt.figure(figsize=(10, 6))
    ...
    # Improvements: Subtitle and Clearer Labels
    ...
    plt.close()
    print("- Saved: stars_by_high_severity_boxplot.png (Improved)")
    ...
    # =========================================================================
    # Chart 5: Days Since Last Release by High-Severity Label (Boxplot)
    # =========================================================================
    plt.figure(figsize=(10, 6))
    sns.boxplot(x='has_high_severity_vulnerability', y='days_since_last_release', data=df, palette='Set2', hue='has_high_severity_vulnerability', legend=False)
    plt.title("Maintenance Recency vs. High Severity Status")
    plt.xlabel("Has High-Severity Vulnerability?")
    plt.ylabel("Days Since Last Release")
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, "days_since_release_by_high_severity_boxplot.png"), dpi=300)
    plt.close()
    print("- Saved: days_since_release_by_high_severity_boxplot.png")

    # =========================================================================
    # Chart 6: Repository Status Distribution
    # =========================================================================
    ...
    # =========================================================================
    # Chart 7: Top 15 Packages by Vulnerability Count (Horizontal Bar)
    # =========================================================================
    top15 = df.nlargest(15, 'vulnerability_count')
    plt.figure(figsize=(12, 8))
    sns.barplot(x='vulnerability_count', y='package_name', data=top15, palette='flare', hue='package_name', legend=False)
    ...
    # =========================================================================
    # Chart 8: Vulnerability Count Distribution (Boxplot)
    # =========================================================================
    plt.figure(figsize=(10, 6))
    ...
    print("-"*40)
    print(f"Avg Days Since Release (High): {avg_days_high:.1f} days")
    print(f"Avg Days Since Release (Low):  {avg_days_low:.1f} days")
    print("="*40)
